...
import com.jhone.demo.emoji.Message;
import com.jhone.demo.emoji.MessageAdapter;
import com.jhone.demo.emoji.ParseEmojiMsgUtil;
import com.jhone.demo.emoji.SelectFaceHelper;
import com.jhone.demo.emoji.Util;
...
public class EmojiActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initData();
		mAdapter = new MessageAdapter(EmojiActivity.this, mData);
	...
	View.OnClickListener faceClick = new View.OnClickListener() {
		...
		public void onClick(View v) {
			if (null == mFaceHelper) {
				mFaceHelper = new SelectFaceHelper(EmojiActivity.this, addFaceToolView);
			...
			if (isVisbilityFace) {
				...
				hideInputManager(EmojiActivity.this);
			}
		}
	};
	View.OnClickListener sendClick = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			String msgStr = ParseEmojiMsgUtil.convertToMsg(mEditMessageEt.getText(), EmojiActivity.this);// 这里不要直接用mEditMessageEt.getText().toString();
